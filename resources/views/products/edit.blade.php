    ...
    <form action="{{ route('products.update',$product->id) }}" method="POST">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="email" name="contact" value="{{ $product->contact }}" class="form-control" placeholder="example@gmail.com">
            </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-6">
            <div class="form-group">
                <strong>Manufacture Date:</strong>
                <input type="date" name="manufacture_date" value="{{ $product->manufacture_date }}" class="form-control" placeholder="Manufacture Date">
            </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-6">
            <div class="form-group">
                <strong>Manufacture Time:</strong>
                <input type="time" name="manufacture_time" value="{{ $product->manufacture_time }}"  class="form-control" placeholder="Manufacture Time">
            </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-6">
            <div class="form-group">
